...
/**
 * <h1>Mouth</h1>
 * The class of the Mouth extends to class an HeadOrgan . 
...
public class Mouth extends HeadOrgan {
	...
	/**
	*The method eat chooses a random value from enum Food
	...
	*/
	...
	/**
	*The method say chooses a random value from enum Phrases 
	*and return it to the brain method getDataOrgans
	*/
